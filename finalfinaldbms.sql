...
INSERT INTO DeliveryPartner VALUES (2,'HILTON WRIGHT','light@gmail.com');
...
-- --------------------------------------------------------------------------------------------------------------- 
-- DB TRANSACTIONS for submission 6

-- Non-conflicting transactions
-- Transaction 1: Insert a new customer
START TRANSACTION;
INSERT INTO Customer (CustomerID, CustomerName, HOUSENUMBER, City, State, Pincode, EmailID, PhoneNumber, Password)
VALUES (31, 'John Doe', '123 Main St', 'Chicago', 'IL', '60601', 'johndoe@example.com', '1234567890', 'password31');
COMMIT;

-- Transaction 2: Update the quantity of a product in stock
START TRANSACTION;
UPDATE Items
...
-- Transaction 3: Insert a new order
START TRANSACTION;
INSERT INTO Orders (CustomerID, OrderID, OrderDate, Quantity, CurrentStatus)
VALUES (1, 31, '2024-04-20', 3, 1);
COMMIT;

-- Transaction 4: Update delivery status
START TRANSACTION;
UPDATE Orders
SET CurrentStatus = 2
WHERE OrderID = 31;
...
-- Transaction 5: Attempt to update quantity in stock and insert a new order
START TRANSACTION;
UPDATE Items
SET QUANTITY = QUANTITY - 10
WHERE ProductID = 2;
INSERT INTO Orders (CustomerID, OrderID, OrderDate, Quantity, CurrentStatus)
VALUES (2, 32, '2024-04-20', 5, 1);
COMMIT;

-- Transaction 6: Attempt to order the same product at the same time by 2 different customers.
START TRANSACTION;
INSERT INTO Orders (CustomerID, OrderID, OrderDate, Quantity, CurrentStatus)
VALUES (2, 33, '2024-04-20', 5, 1);
INSERT INTO Orders (CustomerID, OrderID, OrderDate, Quantity, CurrentStatus)
VALUES (6, 34, '2024-04-20', 5, 1);
COMMIT;
